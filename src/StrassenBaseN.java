public class StrassenBaseN {

    int size;
    int base;

    public StrassenBaseN(int size, int base) {
        this.size = size;
        this.base = base;
    }

    public long[][] strassenBaseN(long[][] a, long[][] b) {
        int n = a.length;
...
//            result[0][0] = a[0][0] * b[0][0];
            ...
            long[][] m1 = strassenBaseN(add(a11, a22), add(b11, b22));
            long[][] m2 = strassenBaseN(add(a21, a22), b11);
            long[][] m3 = strassenBaseN(a11, minus(b12, b22));
            long[][] m4 = strassenBaseN(a22, minus(b21, b11));
            long[][] m5 = strassenBaseN(add(a11, a12), b22);
            long[][] m6 = strassenBaseN(minus(a21, a11), add(b11, b12));
            long[][] m7 = strassenBaseN(minus(a12, a22), add(b21, b22));
